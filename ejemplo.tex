...
Estudios previos \cite{} muestran que el tamaño de los objetos se expande varios órdenes de magnitud, desde decenas de B hasta decenas de MB.
...
\subsection{Evolución de la carga del servidor durante el día}
